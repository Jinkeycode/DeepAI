...
model = Sequential()
model.add(layers.Conv2D(filters=96, kernel_size=(11, 11), strides=4, input_shape=(227, 227, 1), activation='relu'))
...
model.fit(images_tranform_gray28_to_rgb227(mnist.train_images), utils.to_categorical(mnist.train_labels), batch_size=500, epochs=5, verbose=1, shuffle=True)
